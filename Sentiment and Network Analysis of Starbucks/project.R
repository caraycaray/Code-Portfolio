...
#2. Insert Values
api_key <-"bdVh98TpNtRqsXJxZBnEyqHbe"
api_secret <- "iEcNLuvGZbVNeoZXXQATlk1RyOsxg6jNJkWr4JJcpnv64HZQvP"
access_token <- "280008380-jEzPDUYeq0vrUZqF6rpsguyg1VNYxFm9oFaLoels"
access_token_secret <-"So8KtdmECUh1356ArHhJVOs8SACPF3aqwzpmvbaxmIam4"
...
write.csv(starbucks, file = 'C:/Users/Cara You/Desktop/duke/Digital Marketing/starbucks.csv', row.names = F)
getwd()
# Data Cleaning and Preparation
#1. Reading Data File
starbucks<-read.csv(file.choose(), header=T) #choose the tesla.csv file
